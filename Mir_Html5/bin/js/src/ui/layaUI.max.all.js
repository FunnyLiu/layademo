...
(function (ui) {
    ...
    (function (Scene) {
        var loadingUI = /** @class */ (function (_super) {
            ...
            loadingUI.uiView = { "type": "View", "props": { "width": 1024, "height": 768 }, "child": [{ "type": "Image", "props": { "y": 9, "x": 0, "skin": "comp/scene/login/image_bg.png" } }, { "type": "Image", "props": { "y": 646, "x": 267, "skin": "comp/scene/loading/Game_Start_Desc.png" } }, { "type": "ProgressBar", "props": { "y": 592, "x": 200, "var": "m_Progress", "skin": "comp/scene/loading/progressBar_q.png" } }, { "type": "Image", "props": { "y": 560, "x": 163, "skin": "comp/scene/loading/GameStart_ProgressBar_Bg.png" } }] };
            return loadingUI;
        }(View));
...
(function (ui) {
    ...
    (function (Scene) {
        var LoginUI = /** @class */ (function (_super) {
            ...
            LoginUI.uiView = { "type": "View", "props": { "width": 1334, "height": 750 }, "child": [{ "type": "Image", "props": { "y": 8, "x": 0, "width": 1334, "skin": "comp/scene/login/image_bg.png", "height": 750 } }, { "type": "Image", "props": { "y": 282, "x": 516, "skin": "comp/scene/login/image_login.png" } }, { "type": "TextInput", "props": { "y": 349, "x": 599, "width": 149, "var": "m_TextUser", "text": "yiyi", "skin": "comp/textinput.png", "height": 22, "fontSize": 18, "font": "SimSun", "color": "#ffffff" } }, { "type": "TextInput", "props": { "y": 383, "x": 599, "width": 149, "var": "m_TextPaswd", "text": "yiyibushe", "skin": "comp/textinput.png", "height": 22, "fontSize": 18, "font": "SimSun", "color": "#ffffff" } }, { "type": "Button", "props": { "y": 428, "x": 633, "var": "m_btnEnter", "skin": "comp/scene/login/btn_enter.png" } }] };
            return LoginUI;
        }(View));
...
(function (ui) {
    ...
    (function (Window) {
        var itemtipsUI = /** @class */ (function (_super) {
            ...
            itemtipsUI.uiView = { "type": "Dialog", "props": {}, "child": [{ "type": "Image", "props": { "y": 1, "x": 1, "width": 318, "var": "m_image_bg", "skin": "comp/dialog/itemtips/image_bg.png", "sizeGrid": "11,11,11,11", "height": 78, "alpha": 0.5 } }, { "type": "Label", "props": { "y": 14, "x": 93, "width": 103, "var": "m_label_name", "text": "斩首者", "strokeColor": "#080808", "stroke": 1, "mouseEnabled": false, "height": 25, "fontSize": 24, "font": "SimSun", "color": "#f8f3f3", "align": "center" } }, { "type": "Label", "props": { "y": 51, "x": 98, "width": 103, "text": "糖糖糖糖糖糖糖糖糖糖糖糖糖糖", "height": 25, "color": "#f8f3f3" } }, { "type": "Button", "props": { "y": 3, "x": 268, "var": "m_btn_close", "stateNum": 1, "skin": "comp/main/other/button_close.png" } }, { "type": "Image", "props": { "y": 8, "x": 12, "width": 64, "var": "m_image_icon", "skin": "comp/dialog/itemtips/image_bg.png", "height": 64 } }, { "type": "Image", "props": { "y": 99, "x": 215, "skin": "comp/dialog/itemtips/image_egg.jpg" } }] };
            return itemtipsUI;
        }(Dialog));
