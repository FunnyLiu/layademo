 ...
 */
    ...
    LogicManager.prototype.CheckFouceTarget = function (x, y) {
        ...
        for (var i = 0; i < this.m_EntityList.length; i++) {
            ...
            if (pEntity.IsDie() == false && pEntity.IsDisappeared() == false) {
                ...
                // rect.x = glop.x;
                // rect.y = glop.y;
                // rect.width = NORMAL_WIDTH;
                // rect.height = NORMAL_HEIGHT;
                // rect.width = ModelAni.GetCurrentFrameWidth();
                // rect.height = ModelAni.GetCurrentFrameHeight();
    ...
    LogicManager.prototype.OnMouseDown = function (x, y) {
        ...
        //与NPC对话
        if (pEntity != null && pEntity.GetEntityType() == Entity.EntityType.Npc) {
