...
(function (UI) {
    var UIManager = /** @class */ (function () {
        function UIManager() {
            ...
            this.m_LoadItem =
                [
                    { url: "res/atlas/comp/main/log.json", type: Laya.Loader.ATLAS, id: UI.UIDialogID.Log, x: 0, y: pCfg._nHeight - 400, visible: true, },
        ...
        UIManager.prototype.GetLogDialog = function () {
            return this.m_Dialog[UI.UIDialogID.Log];
        };
