...
(function (Entity) {
        ...
        Player.prototype.Think = function () {
            ...
            if (this.m_boPassiveMoving == true) {
                ...
                if (pAttackEntity != null && !pAttackEntity.IsDie() && !pAttackEntity.IsDisappeared()) {
                    this.m_NextUseSkill = NetSystem.NetSystemManager.GetInstance().GetSkillSystem().GetNextUseSkill(pAttackEntity);
                ...
                if (this.m_ArrAutoPath.length == 0) {
                    ...
                    if (this.m_AutoPathNpcInfo != null) {
                        ...
                        if (pNpcEntity != null) {
                            var msgNpcPack = new ClientMsgPack.LogicPack.NpcTalkMsgPack();
     ...
     * */
                ...
                case Entity.StandardActions.SA_RUN:
                    {
                        ...
                        var msgPack = new ClientMsgPack.MovePack.MoveMsgPack();
        ...
        Player.prototype.AutoFindPath = function (nX, nY, pStdNpc) {
