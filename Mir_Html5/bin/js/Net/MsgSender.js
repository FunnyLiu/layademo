...
(function (Net) {
    var MsgSender = /** @class */ (function () {
        ...
        MsgSender.SendDataByPack = function (msgPack) {
            // let buff:ArrayBuffer = msgPack.Serialize();
            // MainSocket.GetInstance().SendData(buff);
        };
        ...
        MsgSender.SendDeleteItem = function (Series) {
            var msg = new ClientMsgPack.BagPack.DeleteItemMsgPack();
            msg._Series = Series;
            MsgSender.SendDataByPack(msg);
        };
        MsgSender.SendLootItem = function (nPacketId) {
            var msg = new ClientMsgPack.LootPack.LootItemMsgPack();
            msg._nPacketId = nPacketId;
            MsgSender.SendDataByPack(msg);
        };
        return MsgSender;
    }());
